...
def make_image(data_x,data_y, title,axe_x = [1500,1600,'titre de l\'axe x'], axe_y = [-100,0,'titre de l\'axe y'],label = 'Label oublié', couleur = "FFAA22"): 
    ...
    plt.plot(data_x,data_y, linewidth = 1, color = couleur, label = label)
