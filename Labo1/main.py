...
for i in range(9):
    ...
    data = txt2data(path)
    make_image(data,title='DFB 10C',axe_x=axe_x,axe_y=axe_y,label = str(5*i)+'mA',couleur=new_color(i))
...
for i in range(9):
    ...
    #data["data{0}".format(5*i)] = txt2data(path)
    data = txt2data(path)
    make_image(data,title='DFB 20C',axe_x=axe_x,axe_y=axe_y,label = str(5*i)+'mA',couleur=new_color(i))
...
for i in range(7):
    ...
    #data["data{0}".format(5*i)] = txt2data(path)
    data = txt2data(path)
    make_image(data,title='SLED 10C',axe_x=axe_x,axe_y=axe_y,label = str(20*i)+'mA',couleur=new_color(i))
...
for i in range(7):
    ...
    #data["data{0}".format(5*i)] = txt2data(path)
    data = txt2data(path)
    make_image(data,title='SLED 20C',axe_x=axe_x,axe_y=axe_y,label = str(20*i)+'mA',couleur=new_color(i))
plt.show()
